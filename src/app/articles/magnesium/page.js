    ...
    <div dir={isRtl ? 'rtl' : 'ltr'} style={{ fontFamily: bf, background: PAGE_BG, minHeight: '100vh', transition: 'background 0.4s ease, color 0.4s ease' }}>
      ...
      <article style={{ maxWidth: 720, margin: '0 auto', padding: '100px 24px 100px', background: PAGE_BG, transition: 'background 0.4s ease' }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: isRtl ? 18 : 17, lineHeight: lh, color: TEXT_SECONDARY, fontWeight: 300, marginBottom: 20, fontFamily: bf, overflow: 'hidden', paddingTop: isRtl && c.subtitle.startsWith('ތ') ? 24 : 0 }}>
            {isRtl && c.subtitle.startsWith('ތ') ? (
              <>
                <img
                  src="/dropcap-thaa.png"
                  alt="ތ"
                  style={{
                    float: 'right',
                    height: 165,
                    ...
                    marginBottom: 6,
                    filter: IMG_FILTER,
                    shapeOutside: 'url(/dropcap-thaa.png)',
