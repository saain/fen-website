...
const dv = {
  ...
  date: '7 އެޕްރީލް 2026', readTime: '12 މިނެޓުގެ ކިޔުމެއް', refCount: '14 ރިފަރެންސް ހިމެނިފައިވޭ',
  ...
  s2e: { level: 'ވަރުގަދަ', color: '#2d6a4f', text: 'އާރް.ސީ.ޓީ (RCT) ތަކުގެ ގިނަ މެޓަ-އެނަލިސިސްތަކުން ދައްކާގޮތުގައި، ހާއްސަކޮށް ލޭގެ ޕްރެޝަރު މަތި މީހުންގެ ލޭގެ ޕްރެޝަރު ކޮންމެވެސް މިންވަރަކަށް ދަށްކޮށްދެއެވެ. 2025 ވަނަ އަހަރުގެ ހައިޕަރޓެންޝަން މެޓަ-އެނަލިސިސް (38 އާރް.ސީ.ޓީ، n=2,709) އަކީ މިހާތަނަށް މިކަމާ ގުޅޭގޮތުން ހެދިފައިވާ އެންމެ ފުރިހަމަ ދިރާސާއެވެ.' },
  ...
  s3e: { level: 'މެދު މިންވަރެއްގެ', color: '#b5651d', text: '325 މީހުން ބައިވެރިވި ހަތް އާރް.ސީ.ޓީ އިން ޑިޕްރެޝަން ސްކޯރތަކަށް ބޮޑު ކުރިއެރުމެއް އަންނަކަން ދައްކައެވެ. މިއީ އުންމީދީ ނަތީޖާއެއް ނަމަވެސް، ބައިވެރިވި މީހުންގެ އަދަދު މަދުވުމުން މީގެ އިތުރު ބޮޑެތި ދިރާސާތައް ބޭނުންވެއެވެ.' },
  ...
  s4e: { level: 'މެދު މިންވަރެއްގެ', color: '#b5651d', text: 'އޮބްޒަވޭޝަނަލް ޑޭޓާތަކުން މިކަމަށް ތާއީދުކުރެއެވެ. އާރް.ސީ.ޓީ ހެކިތައް ހުރީ އެކި ގޮތަށެވެ، ނަމަވެސް ހާއްސަކޮށް މެގްނީޒިއަމް މަދު މީހުންނާއި އުމުރުން ދުވަސްވީ މީހުންގެ މެދުގައި މީގެ ނަތީޖާ ރަނގަޅެވެ.' },
  ...
  s5e: { level: 'މެދުމިންވަރެއްގެ', color: '#b5651d', text: 'ސީ.އާރު.ޕީ (CRP) ދަށްވުން ހުރިހާ ދިރާސާތަކަކުން ވެސް އެއްގޮތަކަށް ފާހަގަކުރެވެއެވެ. އޮކްސިޑޭޓިވް ސްޓްރެސްގެ އެހެން މާކަރުތަކަށް ކުރާ އަސަރުތަކާ މެދު ވަކި ގޮތެއް ނުނިންމެއެވެ.' },
  s6t: 'ކޮން ބާވަތެއްގެ ސަޕްލިމެންޓެއް ހިޔާރުކުރާނީ؟',
  s6: ['ހުރިހާ މެގްނީޒިއަމް ސަޕްލިމެންޓްތަކަކީ އެއްވަރެއްގެ އެއްޗެއް ނޫނެވެ. މެގްނީޒިއަމް ހުންނަ ބާވަތުގެ ސަބަބުން، އެ ހަށިގަނޑަށް ދަމައިގަންނަ މިންވަރާއި ބޭނުންކުރެވޭ މިންވަރު ތަފާތުވެއެވެ:'],
